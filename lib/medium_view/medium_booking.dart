...
class MediumBooking extends StatefulWidget {
  @override
  State<MediumBooking> createState() => _MediumBookingState();
}

class _MediumBookingState extends State<MediumBooking> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("MAKE BOOKINGS HERE",
        style: TextStyle(
          color: Colors.brown,

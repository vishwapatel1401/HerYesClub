...
import 'package:test_project/mobile_view/admin_create_blog.dart';
...
class AdminBlog extends StatefulWidget {
  ...
  @override
  State<AdminBlog> createState() => AdminBlogState();
}

class AdminBlogState extends State<AdminBlog> {
        ...
        children: <Widget>[
          FloatingActionButton(
            onPressed: (){
                  Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AdminCreateBlog()),
                );
            },

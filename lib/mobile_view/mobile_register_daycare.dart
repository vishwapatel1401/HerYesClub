...
class MobileRegisterDayCare extends StatefulWidget {
  const MobileRegisterDayCare({super.key});

  @override
  State<MobileRegisterDayCare> createState() => MobileRegisterDayCareState();
}

class MobileRegisterDayCareState extends State<MobileRegisterDayCare> {
